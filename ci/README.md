...
| impl-a conformance | `implementations/python/spp_verify.py --suite` | Python implementation consumes committed artifact |
| impl-b conformance | `implementations/typescript/src/cli.ts --suite` | TypeScript implementation consumes committed artifact |
| impl-b typecheck | `implementations/typescript tsc --noEmit` | TypeScript implementation type-checks |
