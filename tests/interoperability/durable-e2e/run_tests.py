...
agents' behalf; every protocol action is performed by the `clients/agent-a`
(Python) and `clients/agent-b` (TypeScript) CLIs as separate processes. Served
...
Usage:
    python interoperability/durable-e2e/run_tests.py [--keep]
"""
