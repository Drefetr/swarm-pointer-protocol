...
suite, and the external-review record. Tag `v1`; the tag pins the
...
The `v1.zip` asset lays out the package exactly as the frozen
...
`MANIFEST.sha256`, and produces a deterministic `dist/v1.zip` plus
